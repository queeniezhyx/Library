...
function init() {
  ...
  const sample1 = new Book("The Pragmatic Programmer", "Andrew Hunt", 352, true);
  const sample2 = new Book("Clean Code", "Robert C. Martin", 464, false);
